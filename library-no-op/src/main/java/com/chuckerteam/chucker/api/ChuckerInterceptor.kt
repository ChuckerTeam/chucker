...
import com.chuckerteam.chucker.api.internal.support.ChuckerHeaderFilter
...
public class ChuckerInterceptor private constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        val filteredRequest = ChuckerHeaderFilter.removeAllChuckerHeadersFromRequest(chain.request())
