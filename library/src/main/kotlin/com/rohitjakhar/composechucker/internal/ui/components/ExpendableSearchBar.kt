...
@Composable
internal fun ExpandableSearchView(
...
@Composable
internal fun CollapsedSearchView(
...
@Composable
internal fun ExpandedSearchView(
    searchDisplay: String,
    onSearchDisplayChanged: (String) -> Unit,
    onSearchDisplayClosed: () -> Unit,
    onExpandedChanged: (Boolean) -> Unit,
...
@Preview
@Composable
internal fun CollapsedSearchViewPreview() {
    ChuckerTheme {
        Surface(
...
@Preview
@Composable
internal fun ExpandedSearchViewPreview() {
    ChuckerTheme {
        Surface(
            color = MaterialTheme.colorScheme.primary
        ) {
